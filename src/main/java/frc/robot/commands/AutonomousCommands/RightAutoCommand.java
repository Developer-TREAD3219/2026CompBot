...
//TO DO: Implement the right auto routine. This will likely involve driving forward, then turning and shooting. You can use the existing DriveSubsystem and ShooterSubsystem commands to help with this.
...
public class RightAutoCommand extends Command {
  ...
  public RightAutoCommand(ClimberSubsystem climber, DriveSubsystem drive, IndexerSubsystem indexer,
      IntakeArmSubsystem intakeArm, LauncherSubsystem launcher) {
